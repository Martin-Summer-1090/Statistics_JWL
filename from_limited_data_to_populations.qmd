...
But don't be intimated or afraid. You do not have to be able to understand the details of this 
curve nor do you have to be able to manipulate this equation. These things is something that R
can do for you and we will learn how we work with the normal curve in R.

```{r}
data <- rnorm(1000, mean = 0, sd = 1)
x <- seq(-4, 4, length.out = 1000)
y <- dnorm(x, mean = 0, sd = 1)
plot(x, y, type = "l", lwd = 2, xlab = "Standard units", ylab = "Percent per standard unit", main = "The Normal Curve")
