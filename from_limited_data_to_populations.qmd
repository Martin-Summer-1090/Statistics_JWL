...
the larger group we are ultimatly interested in and from which the sample has been taken. Technicalls this
is also often called **internal validity**.

Here we come to a crucial idea how bias can be avoided, the idea of **random sampling**.
