...
graphics will be put on the platform as separate files. In addition, mainly for the interaction with
my past and future self, I keep a versioning of the notes on a public github archive, which may
also be accessed by colleagues, and of course by the Seitwerk team. The github repository's address is:
