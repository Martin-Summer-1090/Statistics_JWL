...
in the direction of a very broad participation. This is a result of both economic
...
among the youth of sub Saharan Africa - for example - still below 50 %.

Education policies have thus widely debated in international policy circles and 
lead to debates as well as to seemingly unresolvable controveries about what is needed
and what works.

The majority view in international policy circles has been that the most urgent need is
to bring children into the class room and let them be taught by well trained teachers and
the rest will follow automatically. This entails policies to make sure that children have
access to a school nearby and the free provision of basic education.

But enrollment does not automatically mean that all the children enrolled actually attend.
For example, we know from the DHS, the demographic an health survey you learned about
in previous lectures, that there is a gap between enrollment and attendance. From the
surveys we also know that the absence is not necessarily driven by the fact that the
