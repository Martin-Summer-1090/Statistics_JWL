...
Discuss the difference between a cross section and longitudinal data, discuss that a gap in averages can
hide substantial overlap in distribution (needs microdata, though; DHS?). To do
...
```{r}
hist_breaks <- c(60, 61, 62, 63, 64, 65, 66.89479, 67, 68, 69.89479, 70, 71, 72, 73, 74, 75, 76)
...
```{r}
hist_breaks <- c(60, 61, 62, 63, 64.18976, 65, 66, 67, 68, 69, 70, 71.79647, 72, 73, 74, 75, 76)
color_list <- rep('#C6E2FF', length(hist_breaks))
...
Below are three sketches of a histogram (we call them "sketches" because they display a schematic
shape of a hypothetical histogram. This is why these sketches do not look like real histograms.) Match the sketch with the description. Some descriptions will be left over. Give your reasoning in each case. The
...
![(a)](pictures/hist_ex_1.png){#fig-hist_ex_1}

![(b)](pictures/hist_ex_2.png){#fig-hist_ex_2}
![(c)](pictures/hist_ex_3.png){#fig-hist_ex_3}
:::
