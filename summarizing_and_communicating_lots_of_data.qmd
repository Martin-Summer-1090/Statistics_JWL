...
```{r}
#| include: false
hist_breaks <- hist(dat$Height)$breaks
...
![The observations around one standard deviation from the mean.](pictures/hist_68.png){#fig-hist_68}
...
![The observations around two standard deviation from the mean.](pictures/hist_95.png){#fig-hist_95}
...
I would like to use survey data on height to compare the height of men and women.
The main didactical point will be to show that the height of men and women differ 
on average. But when we bring in the distribution we see there is lot of overlap.
Lessons to be learned: Avoid the gap instinct. Discuss the analogy of math scores
between boys and girls.

I have not yet completed this section because I need to learn how to download and
process the height and weight microdata which can be accessed through DHL. But I have
not yet learned how to do so.

## Describing Relationships between data

I use height and weight when I have the DHL data to show an example of correlation
patterns and the tool of a scatterplot. This finishes our toolset of 
exploratory graphical data display tools.


## Describing Trends

Here we can again use the DHL data to end this section with a positive message.
There is a positive trend in human height around the world. This is an indicator
that over time living conditions have improved globally. 
