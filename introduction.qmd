...
them into data can be challenging. The basic question raised in 
...
But even before you go about to think how you might count all the trees on
...
a tree. But what some might consider a tree others will consider just a shrub. 
...
define something
so seemingly obvious as a tree, you can imagine that more complex concepts
