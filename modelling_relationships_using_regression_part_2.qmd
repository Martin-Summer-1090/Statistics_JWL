...
What about those who are 2 standard deviations below the average? Their height is $67.69 - 2 \time 2.75$, which
...
Associated with each increase of one standard deviation in $x$ there is an increas of only $r$ standard deviations
in $y$ on average.
:::